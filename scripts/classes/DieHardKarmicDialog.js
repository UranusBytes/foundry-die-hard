...
export default class DieHardKarmicDialog extends FormApplication {
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      ...
      width: 1000,
      template: 'modules/foundry-die-hard/templates/die-hard-karmic-config.html',
      id: 'die-hard-karmic-config',
      title: 'Die Hard Karma Config',
    });
  }

  constructor() {
    dieHardLog(false, 'DieHardKarmicDialog - constructor')
    super();
    this.operator = null;
